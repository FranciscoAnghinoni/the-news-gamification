...
import { AdminStatsFilters } from "../services/api";
...
export function FilterModal({
  ...
  const handleApply = () => {
    ...
    onApplyFilters({
      ...
      newsletterDate: localFilters.newsletterDate || undefined,
      minStreak: parseInt(localFilters.minStreak),
    });
  };
  ...
  return (
    <div className="fixed inset-0 bg-marrom/50 flex items-center justify-center z-50">
      <div className="bg-branco rounded-lg p-6 w-full max-w-md">
